(function () {
  ...
  var TRANSLATIONS = {
    ...
    kg: {
      ...
      'Экспорт ▾': 'Экспорт ▾',
      'Скачать SVG': 'SVG экспорттоо',
      'Скачать PNG': 'PNG экспорттоо',
      'Скачать PNG @2x': 'PNG экспорттоо @2x',
      'Скачать PDF': 'PDF экспорттоо',
      'Вырезать': 'Кесүү',
      'Копировать': 'Көчүрүү',
      'Вставить': 'Коюу',
      'Свойства': 'Касиеттер',
      ...
      'Стандартный цикл (↻)': 'Стандарттык цикл (↻)',
      ...
      'Тело скрипта': 'Скрипттин тексти',
      'Результат (resultVariable)': 'Натыйжа (resultVariable)',
      'Шлюз': 'Шлюз',
      'Исключающий (XOR)': 'Эксклюзивдүү (XOR)',
      'Параллельный (AND)': 'Параллель (AND)',
      'Включающий (OR)': 'Инклюзивдүү (OR)',
      'Сложный': 'Татаал',
      ...
      'Шлюзы': 'Шлюздар',
      'Исключающий шлюз (XOR)': 'Эксклюзивдүү шлюз (XOR)',
      'Параллельный шлюз (AND)': 'Параллель шлюз (AND)',
      'Включающий шлюз (OR)': 'Инклюзивдүү шлюз (OR)',
      ...
      'Ошибка экспорта PNG': 'PNG экспорттоо катасы',
      'Позиции сброшены': 'Жайгашуулар баштапкыга кайтарылды',
      'Нет диаграммы': 'Диаграмма жок',
      'Popup заблокирован': 'Калкыма терезе бөгөттөлдү',
