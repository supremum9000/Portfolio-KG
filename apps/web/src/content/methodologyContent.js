    ...
    directions: [
      ...
      },
      {
        ...
        topicBlocks: [
          ...
          {
            title: '3. Практикалык мисал: MVNOʼдеги тобокелдиктер'
          },
          {
      ...
      },
      {
        ...
        topicBlocks: [
          ...
          {
            title: '5-блок. Business Rules жана процесс логикасы',
            items: [
              'Business Rules процесстин бутактануу шарттары катары',
              'XOR / OR gateways',
