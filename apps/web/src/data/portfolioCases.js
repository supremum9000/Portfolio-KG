  ...
  kg: [
    {
      ...
      contextLine: 'Alfa-Mobile · Системдик жана бизнес талдоо · Антифрод',
      summary:
    ...
    },
    {
      ...
      technologies: ['REST API', 'Go', 'Kafka', 'PostgreSQL', 'MongoDB', 'микрокызматтар'],
      outcome: [
    ...
    },
    {
      id: 'atm-consent-signing',
      sectors: ['fintech'],
      title: 'АТМда макулдуктарга кол коюу',
      company: 'Innotech',
      role: 'Жетектөөчү системдик аналитик',
      contextLine: 'Innotech · Системдик жана бизнес талдоо · Финтех',
      summary:
        'АТМдарда кредиттик бюро жана тиешелүү макулдуктарга кол коюу үчүн толук аналитикалык пакетти даярдадым: бизнес негиздөө, талаптар, API долбоорлоосу, маалыматтар модели жана тобокелдиктерди талдоону камтыйт.',
      preparedArtifacts: [
        'Бизнес-кейс жана экономикалык натыйжалар.',
        'Бизнес, функционалдык, функционалдык эмес жана интеграциялык талаптар.',
        'REST API долбоорлоосу жана маалыматтар моделинин артефакттары, анын ичинде класс жана ER диаграммалары.',
        'Финансылык таасирди эсептөө, тобокелдиктерди азайтуу чаралары, CJM жана MVP чек аралары менен тобокелдиктердин сүрөттөмөсү.'
      ],
      technologies: ['REST API', 'Java EE', 'PostgreSQL', 'микрокызматтар'],
      outcome: [
    ...
    },
    {
      ...
      technologies: ['Oracle Primavera', '1C Accounting', '1C UH', '1C ERP', 'AVEVA PDMS', 'CAD тутумдары', 'SOAP', 'MS SQL'],
      outcome: [
    ...
    },
    {
      ...
      preparedArtifacts: [
        ...
        'Аналитикалык отчеттуулук, карызды болжолдоо, сценарийлик талдоо жана фактордук анализ.',
    ...
    },
    {
      ...
      technologies: ['Intergraph Hexagon SDx', 'Intergraph Hexagon SRD', 'CAD тутумдары', 'REST'],
      outcome: [
