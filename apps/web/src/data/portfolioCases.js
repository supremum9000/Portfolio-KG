  ...
  kg: [
    {
      ...
      summary:
        'MVNO операциялары менен банктын алдамчылыкка каршы системасынын кесилишинде телекоммуникация антифрод демилгеси учун аналитикалык артефакттарды жана талаптарды даярдадым: алдамчылык сценарийлери, бизнес учун маанилуу окуялар, аныктоо логикасы жана тобокелдиктерди азайтуу чаралары.',
      preparedArtifacts: [
        'Беш аномалия тобу боюнча классификацияланган алдамчылык сценарийлеринин реестри: журуш-туруш, финансылык, контексттик, техникалык жана кардарларга тиешелуу.',
        'Алдамчылыкты мониторингдоо учун аныктоо корсоткучтору, чек маанилери жана эсептоо ыкмалары.',
        'MVNO жана банктын алдамчылыкка каршы системасын интеграциялоо учун бизнес учун маанилуу окуялар, маалымат булактары жана башкаруу аракеттери.',
      ...
      outcome: [
        ...
        'Кардарлар жана компания учун алдамчылык тобокелдиктери азайтылды.'
      ]
    },
    {
      id: 'ai-voice-assistant',
      sectors: ['telecom'],
      title: 'AI уналгы жардамчысы',
      company: 'Alfa-Mobile',
      role: 'Маалымат коопсуздугу багытынын аналитиги',
      contextLine: 'Alfa-Mobile · Системдик жана бизнес-анализ · Антифрод',
      summary:
        'Абоненттер менен байланышуу учун AI уналгы жардамчысына талаптарды даярдадым, кызмат сценарийлерине жана чечимди андан ары долбоорлоо учун зарыл аналитикалык артефакттарга басым жасадым.',
      preparedArtifacts: [
        'Функционалдык талаптар.',
        'Функционалдык эмес талаптар.',
        'Кардар жолунун карталары (CJM).',
        'Кызмат сценарийлери учун BPMN диаграммалары.'
      ],
      technologies: ['Just AI', 'Kafka', 'Keycloak', 'S3 MinIO', 'IBM DataPower', 'PostgreSQL', 'MongoDB', 'REST'],
      outcome: [
        'Абоненттер менен байланышуу учун AI уналгы жардамчысы ишке киргизилди.'
      ]
    },
    {
      id: 'notification-service',
      sectors: ['telecom'],
      title: 'Эскертме кызматы',
      company: 'Alfa-Mobile',
      role: 'Маалымат коопсуздугу багытынын аналитиги',
      contextLine: 'Alfa-Mobile · Системдик жана бизнес-анализ · Антифрод',
      summary:
        'Эскертме кызматы учун аналитикалык артефакттарды даярдадым, коммуникация сценарийлерине, API сүрөттөмөсүнө жана жогорку деңгээлдеги архитектуралык чек араларга басым жасадым.',
      preparedArtifacts: [
        'Функционалдык талаптар.',
        'BPMN диаграммалары.',
      ...
      technologies: ['REST API', 'Go', 'Kafka', 'PostgreSQL', 'MongoDB', 'Microservices'],
      outcome: [
        'Эскертме кызматы иштелип чыгып, ишке киргизилди.',
        'Бардык эскертмелер ушул кызмат аркылуу ишке ашырылат.'
      ]
    },
    {
      id: 'atm-consent-signing',
      ...
      company: 'Innotech',
      role: 'Жетектоочу системдик аналитик',
      contextLine: 'Innotech · Системдик жана бизнес-анализ · Финтех',
      summary:
        'АТМдарда кредиттик бюро жана тиешелуу макулдуктарга кол коюу учун толук аналитикалык пакетти даярдадым: бизнес негиздоо, талаптар, API дизайны, маалыматтар модели жана тобокелдиктерди анализдоону камтыйт.',
      preparedArtifacts: [
        ...
        'Финансылык таасирди эсептоо, тобокелдиктерди азайтуу чаралары, CJM жана MVP чек аралары менен тобокелдиктердин сүрөттөмөсү.'
      ],
      technologies: ['REST API', 'Java EE', 'PostgreSQL', 'Microservices'],
      outcome: [
        'АТМдарда кредиттик бюро жана тиешелуу макулдуктарга кол коюу ишке киргизилди.',
        'Банктын кардарларына кредит беруу жакшырды.'
      ]
    },
    {
      id: 'engineering-project-management',
      ...
      company: 'Mosinzhproekt',
      role: 'Жетектоочу адис',
      contextLine: 'Mosinzhproekt · Системдик анализ · Курулуш',
      summary:
        'Инженердик долбоорлорду башкаруу маалымат системасы учун максаттуу бизнес-архитектураны жана талаптарды иштеп чыктым. Системанын негизги блоктору: келишимдерди жана долбоордун чыгашаларын башкаруу, БДР/БДДС бюджеттештируу, долбоорлор портфелин башкаруу, инженердик маалыматтар жана документтерди чыгарууну контролдоо, ресурстарды башкаруу, календардык-тармак графиктери жана Oracle Primavera интеграциясы.',
      preparedArtifacts: [
        ...
        'Ишке киргизуу методикасы.'
      ],
      technologies: ['Oracle Primavera', '1C PM'],
      outcome: [
        'Инженердик долбоорлорду башкаруу жана техникалык документ жугуртуу системасы ишке киргизилди.',
    ...
    },
    {
      ...
      summary:
        'Мунай-газ курулушу учун инженердик долбоорлорду башкаруу системасынын архитектурасын иштеп чыктым. Долбоордун максаттары: курулуш иштеринин кечигуу себептерин аныктоо, бирдиктуу байланышкан график аркылуу пландоонун тактыгын жогорулатуу (долбоордук документтер, жеткируу, курулуш), башынан аягына чейин пландоо учун бирдиктуу материалдар жана жабдуулар базасын тузуу, келишим милдеттенмелеринин контролун жакшыртуу, БДР/БДДС тактыгын жогорулатуу жана акча агымындагы узулууларды аныктоо.',
      preparedArtifacts: [
        'Функционалдык талаптар.',
      ...
      technologies: ['Oracle Primavera', '1C Accounting', '1C UH', '1C ERP', 'AVEVA PDMS', 'CAD systems', 'SOAP', 'MS SQL'],
      outcome: [
        'Инженердик долбоорлорду башкаруу системасы ишке киргизилди, пландоо, бюджеттештируу, казыначылык, НСМди башкаруу, келишимдер, актылар жана чектеш системалар менен интеграциялар ишке ашырылды.'
      ]
    },
    {
      id: 'unified-information-space',
      sectors: ['construction', 'oil-gas'],
      title: 'Долбоорлоо институту учун бирдиктуу маалымат мейкиндиги',
      company: 'VNIPIneft',
      role: 'Болум башчысы',
      sectorLabel: 'Мунай-газ жана курулуш',
      contextLine: 'VNIPIneft · Мунай-газ жана курулуш',
      summary:
        'Биринчи жана экинчи деңгээлдеги процесстерди жана учурдагы маалыматтык ландшафтты анализдедим. Негизги маселелерди аныктадым: ар кандай системаларда функциялардын жана маалыматтардын кайталанышы, сан жагынан коп ар турдуу маалымат системалары, карама-каршы маалыматтар жана кайталанган отчеттор. Процесстерди оптималдаштыруу жана реинжиниринг чараларын, ошондой эле долбоорлоо институту учун бирдиктуу маалымат мейкиндигин тузуу стратегиясын сунуштадым.',
      preparedArtifacts: [
        ...
        'Экран формалары, сыноо методикасы жана ишке киргизуу методикасы.'
      ],
      technologies: ['MS SQL', 'JS', '1C ERP', 'Oracle Primavera', 'AutoCAD', 'Aveva PDMS', 'SOAP'],
      outcome: [
        'Долбоорлорду, ресурстарды жана инженердик документ жугуртууну башкаруу учун бирдиктуу маалымат системасы тузулду.',
        'Эрте стадияда инциденттерди болжолдоо, тобокелдиктерди башкаруу жана долбоор иштеринин наркын жана мооноттун баалоо ишке ашырылды.',
        'Долбоорлордун мооноттору жана чыгашалары кыскартылды, долбоор иштеринин сапаты жогорулады.',
        'Системаны болжол менен 800 кызматкер пайдаланган; жалпы колому 6 ТБ болгон болжол менен 450 000 файл иштетилген, айына 90 000 чейин транзакция, эн жогорку натыйжалуулук секундасына 25 транзакция.',
        '1C платформасында структураланган жеткируу процесси менен нолдон иштеп чыгуу жана колдоо болуму (6 кызматкер) тузулду: баштоо, иштеп чыгуу, сыноо эксплуатациясы жана продукцияга чыгаруу.'
      ]
    },
    {
      id: 'financial-management-project-planning',
      sectors: ['construction', 'oil-gas'],
      title: 'Инженердик долбоорлордо бюджеттештируу, келишимдер жана эсептешуулорду башкаруу',
      company: 'Giprovostokneft',
      role: 'Жетектоочу программалык камсыздоо инженери',
      sectorLabel: 'Мунай-газ жана курулуш',
      contextLine: 'Giprovostokneft · Мунай-газ жана курулуш',
      summary:
        'Долбоорлоо институтунда казыначылык, бюджеттештируу (БДР, БДДС, инвестициялык бюджет), финансылык контролдоо жана долбоорду пландоо системаларын иштеп чыгып, ишке киргиздим. Автоматтык тапшырма тузуу менен контроллинг, карызды болжолдоо жана what-if анализи менен аналитикалык отчеттуулук, ошондой эле корпоративдик портал жана Oracle Primavera менен интеграцияларды камтыйт.',
      preparedArtifacts: [
        'Казыначылык, БДДС, БДР жана инвестициялык бюджет модулдары.',
        'Ондуруш, сатуу, эмгек акы, инвестициялар жана кредиттик линиялар боюнча функционалдык бюджеттер.',
        'Коп валюталуу эсептешуулор, келишимдерди эсепке алуу, кошумча келишимдерди козомолдоо жана моонотторду контролдоо.',
        'Аналитикалык отчеттуулук, карызды болжолдоо, what-if анализи жана фактордук анализ.',
        'Долбоорлор боюнча коломдук-календардык пландоо, субподряддык иштерди эсепке алуу жана календардык пландоо.',
        '1C ZUP, корпоративдик портал жана Oracle Primavera менен интеграциялар.'
      ],
      technologies: ['.NET C#', '1C Accounting', 'Intalev Corporate Finance', 'MS SQL', 'MS SharePoint', 'Oracle Primavera', 'SOAP'],
      outcome: [
        'Болжол менен 1000 колдонуучу учун финансылык башкаруу жана долбоорду пландоо системасы ишке киргизилди.',
        'Кыска мооноттуу кредиттик карыз жана ишкананын чыгашалары кыскартылды. Эсептешуулордун ачыктыгы жогорулады, финансылык абалды жана тобокелдиктерди болжолдоо жана контролдоо жакшырды.'
      ]
    },
    {
      id: 'engineering-data-document-management',
      sectors: ['construction'],
      title: 'Инженердик маалыматтарды башкаруу жана инженердик документ жугуртуу',
      company: 'Enter Engineering Russia',
      role: 'Системдик аналитик',
      contextLine: 'Enter Engineering Russia · Системдик анализ · Курулуш',
      summary:
        'Intergraph Hexagon негизинде өнөр жай курулушунда инженердик маалыматтарды башкаруу жана инженердик документ жугуртуу учун талаптарды жана техникалык долбоордун артефакттарын даярдадым.',
      preparedArtifacts: [
        '1D, 2D жана 3D маалыматтарды камтыган инженердик маалыматтарды башкаруу техникалык долбоору.',
        'Техникалык документ жугуртуугө коюлуучу талаптар.',
        'Инженердик документтерди чыгаруу жана тиешелуу инженердик маалымат агымдары учун системанын чек аралары.',
        'SDx инженердик документ жугуртуу системасы катары системалык ландшафттын сүрөттөмөсү.'
      ],
      technologies: ['Intergraph Hexagon SDx', 'Intergraph Hexagon SRD', 'CAD systems', 'REST'],
      outcome: [
        '1D, 2D жана 3D маалыматтарды камтыган инженердик документ жугуртуу жана инженердик маалыматтарды башкаруу системасы ишке киргизилди.'
      ]
    },
    {
      id: 'procurement-supply-chain',
      sectors: ['construction'],
      title: 'Сатып алууларды жана жеткируу чынжырын башкаруу',
      company: 'Enter Engineering Russia',
      role: 'Системдик аналитик',
      contextLine: 'Enter Engineering Russia · Системдик анализ · Курулуш',
      summary:
        'Smart Materials, Smart Reference Data жана 1C ERP USO негизинде өнөр жай курулушу учун сатып алуулар, логистика, жеткируу чынжыры жана курулушту эксплуатацияга тапшыруу процесстери боюнча талаптарды жана техникалык долбоордун артефакттарын даярдадым.',
      preparedArtifacts: [
    ...
    },
    {
      ...
      summary:
        'Жергиликтуу BPMN/ER Modeler иштеп чыктым: BPMN.io (bpmn-js) негизиндеги BPMN редактору жана DBML/dbdiagram.io синтаксисине негизделген жеке DSL боюнча ER редактору.',
      preparedArtifacts: [],
      technologies: [
        'BPMN.io (bpmn-js)',
        'DBML',
      ...
      outcome: [
        'BPMN процесстерин моделдоо жана ER диаграммалары учун жергиликтуу курал ишке киргизилди.',
        'Сервердик инфраструктурасыз бир жумуш мейкиндигинде процесстик жана маалымат моделдерин бириктируу ишке ашырылды.'
      ]
    }
  ]
};
